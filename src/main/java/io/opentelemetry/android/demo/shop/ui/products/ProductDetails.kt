...
import io.opentelemetry.android.demo.shop.ui.rememberAstronomyShopNavController
...
fun ProductDetails(
    ...
    HoneycombInstrumentedComposable(name = "ProductDetailScreen") {
...
fun AddToCartButton(
    ...
    LaunchedEffect(cartUiState.isLoading, shouldNavigate) {
        // Navigate to checkout after successful cart add operation
        if (shouldNavigate && !cartUiState.isLoading && cartUiState.errorMessage == null) {
